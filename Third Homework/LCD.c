...
void InitLCD(void)
{
    INTCON = 0b00000000; //disable all interrupts (for now)
    INTCON2= 0b00000001;
    PORTA = 0;
    PORTC = 0;
    PORTE = 0;
    ...
    TRISA = 0;
    TRISB = 0b01000000; // Make RB6 Input (Already digital)
    TRISC = 0;
    TRISE = 0b00000010; //Make RE1 Input (Already digital)
    TRISF = 0;
    TRISG = 0;
    TRISH = 0b00010000; // Make A/D work. 
    TRISJ = 0;
